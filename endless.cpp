	...
	grenadeIcon(createTexture("res/grenade_icon.png"))
{
	...
	GameMode::spawnEnemies(defaultEnemySpawningCount, texEnemyRight, enemies, tileMap);
...
void EndlessState::logic() {
	...
	// update enemies
	GameMode::updateEnemies(1, allies, texEnemyRight, texEnemyLeft, enemies, tileMap, player);
